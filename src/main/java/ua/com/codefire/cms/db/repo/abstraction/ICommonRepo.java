...
public interface ICommonRepo<T> {
    /**
     * Method which uses an EntityManagerHelper, which provides thread-safe connection
     * in order to create an incoming instance of any Entity class
     * Catches EntityExistsException, PersistenceException and Exception and writes them to log file
    ...
    /**
     * Method which uses an EntityManagerHelper, which provides thread-safe connection in order to retrieve
     * an instance of any Entity class from DataBase by id in DataBase
     * Catches EntityNotFoundException, PersistenceException and Exception and writes them to log file
    ...
    /**
     * Method which uses an EntityManagerHelper, which provides thread-safe connection
     * in order to retrieve an instance of any Entity class, which needs to be deleted from DataBase by Id
     * Catches EntityNotFoundException, PersistenceException and Exception and writes them to log file
     ...
     * Catches ClassCastException, PersistenceException and Exception and writes them to log file
